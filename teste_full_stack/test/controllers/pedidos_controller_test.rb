...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { comprador_id: @pedido.comprador_id, ingresso_id: @pedido.ingresso_id, pago: @pedido.pago } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { comprador_id: @pedido.comprador_id, ingresso_id: @pedido.ingresso_id, pago: @pedido.pago } }
